...
function randomConProbabilidad() {
  var nada = 1.3353648403708858;

  var numeros = [nada, nada, nada, nada, nada, nada, nada, nada, nada, nada, nada, nada, nada, nada, 1];
...
function handleSpin(e) {
  console.log(randomConProbabilidad())
  wheel.spin(randomConProbabilidad())
  //191007
  //20105
}
